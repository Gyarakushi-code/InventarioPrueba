...
db_password = os.getenv("DB_PASSWORD", "oJoXRuCVYdHuUdGUTDQNOfTBKsFMEjPf")
db_name = os.getenv("DB_NAME", "railway")
db_port = int(os.getenv("DB_PORT", 43729))  # También define puerto si quieres ser más seguro
...
def verificarusuario():
    ...
    conexion_db = ConexionBaseDatos(db_host, db_user, db_password, db_name, db_port)
